...
const SECTIONS = [
  {
    ...
    bullets: [
      ...
      "Comments and activity feed on every task",
      "Filter by status, priority, project, or assignee",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Sound, in-app, and browser notification alerts",
  ...
  },
  {
    ...
    description:
      "Track output, focus time, and consistency over time. Switch between personal stats and a team leaderboard.",
    bullets: [
      "16-week activity heatmap: tasks or focus sessions",
      "Productivity score combining tasks, focus, and streak",
      "7, 30, and 90-day range selector",
      "Daily focus time and task completion trend",
      "Consecutive-day streak counter",
      "Team leaderboard for workspace owners and admins",
    ],
  },
  {
    icon: FolderOpen,
