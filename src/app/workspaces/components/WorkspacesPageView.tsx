          ...
          <div className="flex-1 min-w-0">
            ...
            {currentWorkspace && (
              <p className="text-xs text-muted-foreground mt-2">
                Current: <span className="font-medium text-foreground">{currentWorkspace.name}</span>
              </p>
            )}
          </div>
        </div>
          ...
          <section>
            ...
            {!showCreate ? (
              <button
                ...
                className={cn(
                  "w-full flex items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border",
